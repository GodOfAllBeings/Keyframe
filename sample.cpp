...
InitGraphics( void )
{
	...
	Xpos.AddTimeValue(   2.f,  800.f );
	Xpos.AddTimeValue(4.f, 1000.f);
	Xpos.AddTimeValue(5.f, 700.f);
	Xpos.AddTimeValue(6.f, 500.f);
	Xpos.AddTimeValue(8.f, 300.f);
	Xpos.AddTimeValue(10, 0.f);

	Ypos.AddTimeValue(    0.f,    0.f );
	Ypos.AddTimeValue(   2.f,  500.f );
	Ypos.AddTimeValue(4.f, 0.f);
	Ypos.AddTimeValue(5.f, 1000.f);
	Ypos.AddTimeValue(6.f, 500.f);
	Ypos.AddTimeValue(8.f, 300.f);
	Ypos.AddTimeValue(10.f, 0.f);

	Zpos.AddTimeValue(    0.f,    0.f );
	Zpos.AddTimeValue(   2.f, 1200.f );
	Zpos.AddTimeValue(4.f, 0.f);
	Zpos.AddTimeValue(5.f, 100.f);
	Zpos.AddTimeValue(6.f, 500.f);
	Zpos.AddTimeValue(8.f, 1000.f);
	Zpos.AddTimeValue(10.f, 0.f);

	ThetaX.AddTimeValue(  0.f,    0.f );
	ThetaX.AddTimeValue( 2.f,   1080.f );
	ThetaX.AddTimeValue(4.f, 90.f);
	ThetaX.AddTimeValue(5.f, 145.f);
	ThetaX.AddTimeValue(6.f, 1080.f);
	ThetaX.AddTimeValue(8.f, 360.f);
	ThetaX.AddTimeValue(10.f, 0.f);

	ThetaY.AddTimeValue(  0.f,    0.f );
	ThetaY.AddTimeValue( 2.f,  90.f );
	ThetaY.AddTimeValue(4.f, 270.f);
	ThetaY.AddTimeValue(5.f, 790.f);
	ThetaY.AddTimeValue(6.f, 215.f);
	ThetaY.AddTimeValue(8.f, 720.f);
	ThetaY.AddTimeValue(10.f, 0.f);

	ThetaZ.AddTimeValue(  0.f,    0.f );
	ThetaZ.AddTimeValue( 2.f,  720.f );
	ThetaZ.AddTimeValue(4.f, 760.f);
	ThetaZ.AddTimeValue(5.f, 200.f);
	ThetaZ.AddTimeValue(6.f, 360.f);
	ThetaZ.AddTimeValue(8.f, 780.f);
...
InitLists( void )
{
	...
	for (int i = 0; i <= 10; i ++) {
		if(i == 2 || i==4 || i==5||i==6||i==8||i==10){
			float xpos = Xpos.GetValue(i);
			float ypos = Ypos.GetValue(i);
			float zpos = Zpos.GetValue(i);
			float ax = ThetaX.GetValue(i);
			float ay = ThetaY.GetValue(i);
			float az = ThetaZ.GetValue(i);
			glPushMatrix();
			glTranslatef(xpos, ypos, zpos);
			glRotatef(ax, 1., 0., 0.);
			glRotatef(ay, 0., 1., 0.);
